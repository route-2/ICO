...
return (
  <div>
    ...
    <div className={styles.main}>
      <div>
        <h1 className={styles.title}>Welcome to Devs ICO!</h1>
        <div className={styles.description}>
          You can claim or mint  Dev tokens here
        </div>
        {walletConnected ? (
          <div>
            <div className={styles.description}>
              {/* Format Ether helps us in converting a BigNumber to string */}
              You have minted {utils.formatEther(balanceOfDevTokens)}  Dev
              Tokens
            </div>
            <div className={styles.description}>
              {/* Format Ether helps us in converting a BigNumber to string */}
